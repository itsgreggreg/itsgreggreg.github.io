(function() {
  ...
  describe('Part I', function() {
    ...
    describe('first', function() {
      ...
      it('should accept an index argument that returns that many elemets', function() {
    ...
    describe('each', function() {
      ...
      it('should iterate over objects, providing access to the element, key, and object itself', function() {
